...
export function ContactMeButton() {
  return (
    <a
      href="#contact"
      className="bg-gradient-to-r from-[#0ACF83] via-[#7EF98B] via-23% to-[#7EF98B] to-93% px-[10px] py-[9px] flex flex-row rounded-[6px] mt-[16px] hover:opacity-100 cursor-pointer"
    >
